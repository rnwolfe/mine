...
Make mine feel native in your shell. `mine shell` generates tab completions for bash/zsh/fish, provides recommended aliases, and adds helper functions for git and SSH workflows.
